...
class SQLUtils:
    ...
    def __init__(self):
        self.url=f"""
        postgresql://{self.DB_USER}:{self.DB_PASS}
...
# class bssrapper:
#     def __init__(self):
#         target_url = "https://www.sidhakura.com/policy?page = "
...
# instance = BsScraper()
# instance .scrap_all()
# print(f"TOTAL NWS SCRAPRD {len(instance.news_list)}")            
#    
